...
namespace PurchaseOrder.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> CreateProduct(ProductDetailsModel productDetails)
        {
        ...
        /// <returns></returns>
        [HttpPut]
        public async Task<IActionResult> UpdateProduct(ProductDetailsModel productDetails)
        {
            if (productDetails != null)
            {
